...
class _PriceScreenState extends State<PriceScreen> {
  ...
  // String value = '?';
  Map<String,String> passfunction = {};
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Column(
            children: [
              CryptoCurrencyCard(
                value: iswaiting ? '?' : passfunction['BTC'],
                selectedCurrency: selectedCurrency,
                cryptoCurrency: 'BTC',
              ),
              CryptoCurrencyCard(
                value: iswaiting ? '?' : passfunction['ETH'],
                selectedCurrency: selectedCurrency,
                cryptoCurrency: 'ETH',
              ),
              CryptoCurrencyCard(
                value: iswaiting ? '?' : passfunction['LTC'],
                selectedCurrency: selectedCurrency,
                cryptoCurrency: 'LTC',
              ),
            ],
...
class CryptoCurrencyCard extends StatelessWidget {
  CryptoCurrencyCard({this.selectedCurrency, this.value, this.cryptoCurrency});
